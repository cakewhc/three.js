...
export default QUnit.module("Maths", () => {
	QUnit.module("Math", () => {
		...
		QUnit.test("generateUUID", (assert) => {
			...
			const regex =
				/[A-Z0-9]{8}-[A-Z0-9]{4}-4[A-Z0-9]{3}-[A-Z0-9]{4}-[A-Z0-9]{12}/i;
		...
		QUnit.test("damp", (assert) => {
			assert.strictEqual(
				MathUtils.damp(1, 2, 0, 0.016),
				1,
				"Value equal to lower boundary"
			);
			assert.strictEqual(
				MathUtils.damp(1, 2, 10, 0.016),
				1.1478562110337887,
				"Value within range"
			);
		});
