	...
	QUnit.module("Color", () => {
		...
		QUnit.test("setRGB", (assert) => {
			...
			assert.numEqual(
				c.r.toFixed(2),
				0.3,
				"Red: " + c.r + " (display-p3, in gamut)"
			);
			assert.numEqual(
				c.g.toFixed(2),
				0.5,
				"Green: " + c.g + " (display-p3, in gamut)"
			);
			assert.numEqual(
				c.b.toFixed(2),
				0.7,
				"Blue: " + c.b + " (display-p3, in gamut)"
			);
			...
			assert.numEqual(
				c.r.toFixed(3),
				1.179,
				"Red: " + c.r + " (display-p3, out of gamut)"
			);
			assert.numEqual(
				c.g.toFixed(3),
				0.181,
				"Green: " + c.g + " (display-p3, out of gamut)"
			);
			assert.numEqual(
				c.b.toFixed(3),
				-0.036,
				"Blue: " + c.b + " (display-p3, out of gamut)"
			);
		});
		...
		QUnit.test("getStyle", (assert) => {
			...
			assert.equal(
				c.getStyle(DisplayP3ColorSpace),
				"color(display-p3 0.831 0.637 0.852)",
				"style: display-p3"
			);
		});
