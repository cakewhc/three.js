...
import { zero3, one3, two3, eps, posInf3 } from "../../utils/math-constants.js";
...
export default QUnit.module("Maths", () => {
	QUnit.module("Ray", () => {
		...
		QUnit.test("intersectPlane", (assert) => {
			...
			const e = new Plane().setFromNormalAndCoplanarPoint(
				new Vector3(1, 0, 0),
				one3
			);
			...
			const f = new Plane().setFromNormalAndCoplanarPoint(
				new Vector3(1, 0, 0),
				zero3
			);
