...
export default QUnit.module("Maths", () => {
	QUnit.module("Box3", () => {
		...
		QUnit.test("getBoundingSphere", (assert) => {
			...
			assert.ok(
				d.getBoundingSphere(sphere).isEmpty(),
		...
		QUnit.test("translate", (assert) => {
			...
			assert.ok(
				a.clone().translate(one3).equals(new Box3(one3, one3)),
				"Passed!"
			);
			assert.ok(
				a.clone().translate(one3).translate(one3.clone().negate()).equals(a),
				"Passed!"
			);
			assert.ok(c.clone().translate(one3).equals(b), "Passed!");
			assert.ok(
				b.clone().translate(one3.clone().negate()).equals(c),
				"Passed!"
			);
		});
