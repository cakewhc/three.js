...
export default QUnit.module("Objects", () => {
	QUnit.module("LOD", () => {
		...
		QUnit.test("type", (assert) => {
			...
			assert.ok(object.type === "LOD", "LOD.type should be LOD");
		});
		...
		QUnit.test("addLevel", (assert) => {
			...
			assert.deepEqual(
				lod.levels[0],
				{ distance: 5, object: high, hysteresis: 0.0 },
				"First entry correct."
			);
			assert.deepEqual(
				lod.levels[1],
				{ distance: 25, object: mid, hysteresis: 0.05 },
				"Second entry correct."
			);
			assert.deepEqual(
				lod.levels[2],
				{ distance: 50, object: low, hysteresis: 0.1 },
				"Third entry correct."
			);
		});
