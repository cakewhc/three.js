...
export const clearcoatRoughness = nodeImmutable(
	PropertyNode,
	"float",
	"ClearcoatRoughness"
);
export const sheen = nodeImmutable(PropertyNode, "vec3", "Sheen");
export const sheenRoughness = nodeImmutable(
	PropertyNode,
	"float",
	"SheenRoughness"
);
export const iridescence = nodeImmutable(PropertyNode, "float", "Iridescence");
export const iridescenceIOR = nodeImmutable(
	PropertyNode,
	"float",
	"IridescenceIOR"
);
export const iridescenceThickness = nodeImmutable(
	PropertyNode,
	"float",
